        ...
        questions = [
            {
                ...
                "type": "enum",
                "properties": {"options": ["positive", "negative", "neutral"]},
            },
            {
                "id": "q002",
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyze multilingual customer feedback"
    )
    parser.add_argument("--api-key", required=True, help="Sarvam API key")
    parser.add_argument(
        "--input-file", default="dummy.csv", help="Input CSV file with feedback"
    )
    parser.add_argument(
        "--output-file",
        default="feedback_analysis.csv",
