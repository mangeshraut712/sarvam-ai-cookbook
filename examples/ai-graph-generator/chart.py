...
""".format(
                code="\n".join(
                    "    " + line for line in self.last_generated_code.splitlines()
                )
            )
            ...
            if not any(result.png for result in execution.results):
                st.warning(
                    "No visualization was generated. The code executed successfully but didn't create a plot."
                )
...
def main():
    ...
    st.write(
        "Describe the visualization you want, and I'll create it using the power of AI!"
    )
            ...
            if user_request:
                with st.spinner("🎨 Creating your visualization..."):
                    ...
                    if visualization_data:
                        ...
                        st.error(
                            "Failed to generate visualization. Please try again with a different request."
                        )
            else:
