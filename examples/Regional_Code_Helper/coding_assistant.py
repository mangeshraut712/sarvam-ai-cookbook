...
from config import SARVAM_API_KEY, SARVAM_API_URL, SUPPORTED_LANGUAGES, SYSTEM_PROMPTS
...
class CodingAssistant:
    ...
    def call_sarvam_api(self, messages, temperature=0.7):
        ...
        try:
            ...
            response = requests.post(SARVAM_API_URL, headers=self.headers, json=payload)
    ...
    def explain_concept(self, concept, language):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Explain the concept of {concept} in {SUPPORTED_LANGUAGES[language]}. "
    ...
    def debug_code(self, code, language):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Debug this code and explain in {SUPPORTED_LANGUAGES[language]}:\n{code}",
            },
        ]
        return self.call_sarvam_api(messages)
    ...
    def provide_code_sample(self, topic, language):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Provide a code sample for {topic} with explanations in {SUPPORTED_LANGUAGES[language]}",
            },
        ]
        return self.call_sarvam_api(messages)
