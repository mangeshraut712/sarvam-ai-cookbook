...
def create_powerpoint_presentation(
    slides: list, topic: str, target_lang_name: str
) -> io.BytesIO:
...
if st.session_state.stage == "enter_details":
    ...
    if st.button("Build My Presentation"):
        if not api_key or not topic:
            ...
            with st.spinner(
                "The AI is architecting your presentation... This may take a moment."
            ):
                try:
                    # AI Processing
                    ...
                    st.info(
                        f"Translating content to {SUPPORTED_LANGUAGES[language]}..."
                    )
                    ...
                    st.session_state.file_name = (
                        f"{topic.replace(' ', '_')}_{language}.pptx"
                    )
